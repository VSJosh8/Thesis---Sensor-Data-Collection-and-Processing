...
string BKLabSensorFullReading::shared_readingUnit_array[FULL_READING_SIZE] = { "C" ,  "%" , "?", "V" };
...
public:
	...
	{
		string label_string;
		string title_string = "set title \"Berkeley Lab Temperature Plot\" font \"Arial-bold,11\"\n";
